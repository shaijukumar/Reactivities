...
const ActivityForm : React.FC<IProps> = ({
    ...
    const activityStore = useContext(ActivityStore);const{createActivity, editActivity, submitting, cancelOpenForm} = activityStore;
    ...
    return (
        <Segment clearing>
            <Form onSubmit={handleSubmit}>
                ...
                <Button onClick={cancelOpenForm} floated='right' content='Cancel'/>
            </Form>
        </Segment>
    )
}
